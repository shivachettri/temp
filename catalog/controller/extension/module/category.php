			...
			if ($category['top']) {
				...
				foreach ($children as $child) {
					...
					$children_data[] = array(
						...
						//'thumb_menus' => $this->model_tool_image->resize($child['image'], $this->config->get('config_image_child_width'), $this->config->get('config_image_child_height')), 
				...
				$data['categories'][] = array(
					'category_id' => $category['category_id'],
					//'thumb_menu' => $this->model_tool_image->resize($category['image'], $this->config->get('config_image_category_width'), $this->config->get('config_image_category_height')),          
